...
mock_app.config.from_mapping(test_config)
mock_cache = Cache(mock_app)
...
class TestGetCollection:
    ...
    def test_for_valid_user():
        ...
        bgg_companion_api = BggCompanionApi(request_client=mock_request_client, cache=mock_cache)
